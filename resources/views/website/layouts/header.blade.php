    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-10 col-sm-8 col-md-5 col-lg-4">
                ...
                <p class="phone-no"><i class="anm anm-phone-s"></i>  +92 345 2609059</p>
            </div>
            <div class="col-sm-4 col-md-4 col-lg-4 d-none d-lg-none d-md-block d-lg-block">
                <div class="text-center">
                    <p class="top-header_middle-text"> Zendra Gadgets</p>
                </div>
            </div>
                            ...
                            <div class="megamenu style2">
                                <ul class="grid mmWrapper">
                                    ...
                                    <li class="grid__item large-up--one-whole imageCol"><a href="#"><img
                                                src="   {{ $baseUrl }}/bella_assets/images/megamenu-bg2.jpg"
                                                alt=""></a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <ul class="mini-products-list">
                            <li class="item">
                                <a class="product-image" href="#">
                                    <img src="   {{ $baseUrl }}/bella_assets/images/product-images/cape-dress-1.jpg"
                            ...
                            <li class="item">
                                <a class="product-image" href="#">
                                    <img src="   {{ $baseUrl }}/bella_assets/images/product-images/cape-dress-2.jpg"
