...
<head>
    ...
    <meta charset="utf-8" />
    <title>Sign Up | Zendra Gadgets</title>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-lg-12">
                                    <div class="p-lg-5 p-4">
                                        <div>
                                            <p class="text-muted">Welcome To The Zendra Gadgets | Register and Be A Part Of The Family.</p>
                                        </div>
                                            ...
                                            <form enctype="multipart/form-data" id="registerForm">
                                                ...
                                                <div class="mt-4">
                                                    <a class="btn btn-success w-100" type="button"
                                                        onclick="loginProcess(this)">Register</a>
                                                </div>
